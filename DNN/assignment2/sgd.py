...
batch_size_array = [64, 128, 256, 512, 1024, 2048]
    ...
    with tf.Session(graph=graph) as session:
      ...
      for step in range(num_steps):
        ...
        if step%500==0:
          ...
          print('BatchSize: %d NumSteps: %d TimeElapsed: %.2f Test accuracy: %.1f%%' % (batch_size, step, (end-start), accuracy(test_prediction.eval(), test_labels)))
